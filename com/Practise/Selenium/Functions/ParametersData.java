...
public class ParametersData {
	...
	public static void main(String[] args) throws Exception {
		...
		//XSSFCell cell=excelapi.setCellData("HomePage", 0, 0, "Fail");
		//excelapi.createHyperlink("RegisterData", cell, "F:\\Workspace_Selenium\\NovemberSelenium");
		System.out.println(excelapi.getColCount("RegisterData"));
		System.out.println(excelapi.getCellRowNum("RegisterData", "dob","12/31/1994"));
		/* WebDriver driver;
